  ...
  it("Should set winners", function() {
    ...
    ***********/
    ...
    .then(function(result) {
      ...
      ***********/
        return /*<CODE HERE>*/ auctionInstance.bid({from: accounts[4]}, itemId=2, count=5)
    }).then(function() {
      /**********
      ...
      ***********/
      /*<CODE HERE>*/ assert.notEqual(result, '0x0000000000000000000000000000000000000000', 'winner address set');
      /**********
